...
# ══════════════════════════════════════════════════════════════════════════════
# Fire-and-Forget Handlers (Evolution API)
# ══════════════════════════════════════════════════════════════════════════════
...
async def send_text_message_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp text message via Evolution API."""
    asyncio.create_task(
...
async def send_image_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp image via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
            send_image_async,
...
async def send_video_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp video via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
            send_video_async,
...
async def send_document_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp document via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
            send_document_async,
...
async def send_audio_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp audio via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
            send_audio_async,
...
async def send_location_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp location via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
            send_location_async,
...
async def send_template_message_fire_and_forget(
    ...
    """Fire-and-forget WhatsApp template message via Evolution API."""
    asyncio.create_task(
        _fire_and_forget_task(
...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Send a text message via WhatsApp using Evolution API. Returns immediately while message sends in background.",
        "parameters": {
            "to": {
                "type": "string",
    ...
    },
    {
        ...
        "description": "Send an image via WhatsApp. Image must be publicly accessible. Returns immediately while message sends in background.",
        "parameters": {
    ...
    },
    {
        ...
        "description": "Send a video via WhatsApp. Returns immediately while message sends in background.",
        "parameters": {
            "to": {"type": "string", "description": "Recipient phone with country code"},
    ...
    },
    {
        ...
        "description": "Send a document via WhatsApp. Returns immediately while message sends in background.",
        "parameters": {
            "to": {"type": "string", "description": "Recipient phone with country code"},
    ...
    },
    {
        ...
        "description": "Send an audio file via WhatsApp. Returns immediately while message sends in background.",
        "parameters": {
            "to": {"type": "string", "description": "Recipient phone with country code"},
    ...
    },
    {
        ...
        "required": ["to", "message"],
        "handler": send_generated_audio,  # Already async, doesn't need fire-and-forget (fast TTS)
    },
    {
        "name": "send_whatsapp_location",
        "description": "Send a location via WhatsApp as a Google Maps link. Returns immediately while message sends in background.",
        "parameters": {
            "to": {"type": "string", "description": "Recipient phone with country code"},
    ...
    },
    {
        ...
        "description": "Send a template message (falls back to text with Baileys). Returns immediately while message sends in background.",
        "parameters": {
            "to": {"type": "string", "description": "Recipient phone with country code"},
