...
Usage:
    .venv/bin/python scripts/benchmark.py [--size small|medium|large] [--output results.json]
"""
...
class BenchmarkSuite:
    ...
    def print_summary(self):
        ...
        print("-" * 70)
        print(f"{'Benchmark':<35} {'Rate':>15} {'Duration':>10} {'Memory':>10}")
        print("-" * 70)
        ...
        for result in self.results:
            ...
            print(f"{result.name:<35} {rate_str:>15} {dur_str:>10} {mem_str:>10}")
...
def main():
    ...
    print(f"\n{'=' * 60}")
    print(f"Triple-Hybrid-RAG Performance Benchmark")
    print(f"{'=' * 60}")
